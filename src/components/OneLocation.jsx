				...
				<div class="container">
					...
					<div className="d-flex flex-row py-3">
						...
						<div class="d-flex flex-column">
							<div>
								<div class="my-map-cell" style={{ width: '100%', height: '100%' }}>
							...
							<div class="my-description-cell text-center py-4">
								<h2>{loc.name}</h2>
								<p>{loc.description}</p>
								<h4 className="mt-5">Average Review Score:</h4>
								<h1>{mapsData.rating}</h1>
								<p>out of {mapsData.user_ratings_total} total reviews</p>
							</div>
						</div>
					</div>
